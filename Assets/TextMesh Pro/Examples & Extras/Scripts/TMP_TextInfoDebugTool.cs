...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Draw characterController metrics
        ...
        /// <summary>
        /// Method to draw a rectangle around each characterController.
        /// </summary>
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Get Bottom Left and Top Right position of the current characterController
        ...
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                // Iterate through each characterController of the word
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debug.Log("Start Word Region at [" + currentCharInfo.characterController + "]");

                        // If Word is one characterController
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debug.Log("End Word Region at [" + currentCharInfo.characterController + "]");
                        }
                    }
        ...
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each characterController of the link text
                for (int j = 0; j < linkInfo.linkTextLength; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        // If Link is one characterController
