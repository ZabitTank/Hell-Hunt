        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    // Iterate through each characterController of the line.
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        // Get the vertices of the mesh used by this text element (characterController or sprite).
                        ...
                        // Need to translate all 4 vertices of each quad to aligned with center of characterController.
                        ...
                        // Determine the random scale change for each characterController.
                        ...
                        // Apply the scale change relative to the center of each characterController.
